...
//                binding.bottomMenu.show(ID_HOME,true);
//            } else if(f instanceof SurahFragment) {
//                binding.bottomMenu.show(ID_QURAN,true);
//            } else if(f instanceof FundFragment) {
//                binding.bottomMenu.show(ID_DONATION,true);
//            } else if(f instanceof MoreFragment) {
//                binding.bottomMenu.show(ID_MORE,true);
//            } else if(f instanceof SearchQAFragment) {
//                binding.bottomMenu.show(ID_SEARCH,true);
//            }
//        });
