...
import com.nermin.beadscounter.R
import com.nermin.beadscounter.views.counter.managers.AnimationManager
import com.nermin.beadscounter.views.counter.managers.DrawingBeadsManager
import com.nermin.beadscounter.views.counter.managers.DrawingThreadManager
import com.nermin.beadscounter.views.counter.managers.beadCenterCoordinatesHelper
...
class CounterView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (beadsCount == -1) reset(DEFAULT_BEADS_COUNT)
    }
